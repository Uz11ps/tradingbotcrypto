...
async def get_user_settings(
    ...
    return UserSignalSettingsOut(
        ...
        strategy_impulse_window=effective.strategy_impulse_window,
        strategy_deviation_threshold_pct=effective.strategy_deviation_threshold_pct,
        strategy_min_pinbar_strength=effective.strategy_min_pinbar_strength,
        strategy_max_body_ratio=effective.strategy_max_body_ratio,
        strategy_max_signals_per_cycle=effective.strategy_max_signals_per_cycle,
...
async def update_user_settings(
    ...
    effective = await upsert_user_settings(
        ...
        strategy_impulse_window=payload.strategy_impulse_window,
        strategy_deviation_threshold_pct=payload.strategy_deviation_threshold_pct,
        strategy_min_pinbar_strength=payload.strategy_min_pinbar_strength,
        strategy_max_body_ratio=payload.strategy_max_body_ratio,
        strategy_max_signals_per_cycle=payload.strategy_max_signals_per_cycle,
